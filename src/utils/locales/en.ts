...
const selfIntroduction = {
  ...
  expression1: 'greeting',
  expression2: 'introduction',
  expression3: 'name, nickname',
  expression4: 'birthplace, the town where you grew up',
  expression5: 'company name, occupation',
  expression6: 'hobby',
  expression7: 'conclusion',
  example1: 'Hello.',
  example2: 'Nice to meet you.',
  example3: 'My name is Hana Tanaka. Please call me Hana.',
  example4: 'I was born in Kanagawa but grew up in Tokyo.',
  example5: 'I work for Interchao as a marketing director.',
  example6: 'I like playing the guitar.',
  example7: 'Thank you.',
  // ko: {
  //   expression1: '인사',
  //   expression2: '도입',
...
const hobby = {
  ...
  //   expression2: 'introduction',
  //   expression3: 'name',
  //   expression4: 'place, occupation name',
  //   expression5: 'hobby',
  //   expression6: 'residence',
  //   expression7: 'years',
  //   expression8: 'conclusion',
  // },
  // zh: {
  //   expression1: 'hobby name',
  //   expression2: 'description of hobbies',
  //   expression3: 'How did you start your hobby?',
  //   expression4: 'hobby effect',
  //   expression5: 'about the future',
  // },
...
const job = {
  ...
  // ko: {
  //   expression1: 'occupation',
  //   expression2: 'name of the business',
  //   expression3: 'work content',
  //   expression4: 'differences from other professions',
  //   expression5: 'working hours',
  //   expression6: 'advantages etc.',
  //   expression7: 'disadvantages etc.',
  //   expression8: 'occupation, qualification, degree, ability, etc.',
  // },
  // zh: {
  //   expression1: 'name of the business',
  //   expression2: 'industry / format',
  //   expression3: 'explanation of business content',
  //   expression4: 'specialized field',
  // },
...
const study = {
  ...
  // ko: {
  //   expression1: 'location / situation, purpose',
  //   expression2: 'hope',
  //   expression3: 'usage / usage',
  //   expression4: 'target / reason',
  //   expression5: 'purpose',
  //   expression6: 'purpose',
  // },
  // zh: {
...
const dream = {
  ...
  // ko: {
  //   expression1: 'dream for the future',
  //   expression2: 'what you are good at',
  //   expression3: 'favorite things',
  //   expression4: 'someone like',
  //   expression5: 'to do',
  //   expression6: 'what to aim for,',
  //   expression7: 'unthinking parts, immature parts, etc.',
  // },
  // zh: {
  //   expression1: 'dream for the future',
  //   expression2: 'why I had a dream',
  //   expression3: 'what you want to achieve through your dreams',
  // },
...
const trip = {
  ...
  // ko: {
  //   expression1: 'some country, various countries, country names',
  //   expression2: 'country name',
  //   expression3: 'long / short, days, months, years',
  //   expression4: 'alone, with friends and family',
  //   expression5: 'impressions',
  //   expression6: 'memories details',
  // },
  // zh: {
  //   expression1: 'country name (city name) / person who went with',
  //   expression2: 'place and period of visit',
  //   expression3: 'the best memory',
  //   expression4: 'impressions',
  // },
...
const reborn = {
  ...
  // ko: {
  //   expression1: 'who wants to be',
  //   expression2: 'reason',
  //   expression3: 'gender, status, etc.',
  //   expression4: 'country / location',
  //   expression5: "things i don't want to change",
  // },
  // zh: {
  //   expression1: 'what you want to do when you are reborn',
  //   expression2: 'reason',
  //   expression3: 'conclusion',
  // },
  wordTitle: 'List of expressions',
